-- =============================================================================
-- Steward V1 Remaining Features Migration
-- Safe to run multiple times (fully idempotent)
-- =============================================================================


-- =============================================================================
-- SECTION 1: MILESTONES TABLE (Life Milestone Planner)
-- =============================================================================
...
-- Owner policies (personal milestones where household_id is null, or any owned row)
...
-- Household member policies (shared milestones)
...
create table if not exists sinking_funds (
  ...
  color          text not null default '#C9943F',
  target_amount  numeric not null,
  saved_amount   numeric not null default 0,
...
-- Composite index for date-range queries (common for budgeting)
...
-- =============================================================================
-- SECTION 5: ADD household_id COLUMN TO milestones (backfill if missing)
-- Note: Column is already defined in the CREATE TABLE above. This guard
-- handles cases where the milestones table pre-existed without the column.
-- =============================================================================
